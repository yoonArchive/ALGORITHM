...
public class BOJ7562 {
	...
	public static void main(String args[])throws IOException{
		...
		for(int i=0;i<tc;i++) {
			int l=Integer.parseInt(br.readLine()); //ü���� �� ���� ����
			map=new int[l][l];
			for(int j=0;j<l;j++) {
			...
			int start_x=Integer.parseInt(st.nextToken());//���� ����Ʈ�� �ִ� ĭ�� x��ǥ
			int start_y=Integer.parseInt(st.nextToken());//���� ����Ʈ�� �ִ� ĭ�� y��ǥ
			str=br.readLine();
			st=new StringTokenizer(str," ");
			int goal_x=Integer.parseInt(st.nextToken());//�̵��ϰ��� �ϴ� ĭ�� x��ǥ
			int goal_y=Integer.parseInt(st.nextToken());//�̵��ϰ��� �ϴ� ĭ�� y��ǥ
